        ...
        <v-container fluid class="pa-0">
          ...
          <v-expand-transition>
            <v-row class="mx-0 px-0 collapsible" v-show="!(collapsible && collapsed)">
              ...
              <v-col cols="12" md="8" offset-md="4" class="py-2">
                <div class="caption grey--text">Child beams</div>
                <ul v-if="node.childBeams && node.childBeams.edges.length > 0">
                  <li v-for="(edgep, index) in node.childBeams.edges" :key="index">
